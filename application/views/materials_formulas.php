...
<body>
	...
	<nav class="nav nav-pills" data-spy="affix" data-offset-top="205" style="margin-bottom: 15px;">
		<a class="nav-link" href='<?php echo site_url('formulas/formulas_management')?>'>配方管理</a> 
		<a class="nav-link active" href='<?php echo site_url('materials_formulas/materials_formulas_management')?>'>配方原料組合管理</a> 
